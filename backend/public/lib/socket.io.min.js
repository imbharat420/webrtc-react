               ...
               l(t, [
                  {
                     key: 'encode',
                     value: function (t) {
                        return (t.type !== p.EVENT && t.type !== p.ACK) || !d.hasBinary(t)
                           ? [this.encodeAsString(t)]
                           : ((t.type = t.type === p.EVENT ? p.BINARY_EVENT : p.BINARY_ACK), this.encodeAsBinary(t));
                     },
                  },
                  {
                     key: 'encodeAsString',
                     value: function (t) {
                        var e = '' + t.type;
                        return (
                           (t.type !== p.BINARY_EVENT && t.type !== p.BINARY_ACK) || (e += t.attachments + '-'),
                           t.nsp && '/' !== t.nsp && (e += t.nsp + ','),
                           null != t.id && (e += t.id),
                  ...
                  [
                     {
                        ...
                        value: function (t) {
                           var e;
                           if ('string' == typeof t)
                              (e = this.decodeString(t)).type === p.BINARY_EVENT || e.type === p.BINARY_ACK
               ...
               return (
                  ...
                  (n = [
                     ...
                     },
                     {
                        ...
                        value: function () {
                           return (
                              this.connected && this.packet({ type: p.PacketType.DISCONNECT }),
                              this.destroy(),
                  ...
                  (n = [
                     ...
                     },
                     {
                        ...
                        value: function () {
                           var t,
                              e = this;
                           if (this.opts.rememberUpgrade && p.priorWebsocketSuccess && -1 !== this.transports.indexOf('websocket')) t = 'websocket';
                           else {
         ...
         t.exports = function (t, e, n) {
            ...
            return o && u instanceof Blob
               ? e
                  ...
                  : s(u, n)
               : i &&
                 (u instanceof ArrayBuffer || ((c = u), 'function' == typeof ArrayBuffer.isView ? ArrayBuffer.isView(c) : c && c.buffer instanceof ArrayBuffer))
               ? e
                                    ...
                                    f.encodePacket(r, e.supportsBinary, function (t) {
                                       ...
                                       v ||
                                          ...
                                          e.opts.perMessageDeflate &&
                                             ('string' == typeof t ? Buffer.byteLength(t) : t.length) < e.opts.perMessageDeflate.threshold &&
                                             (n.compress = !1));
                                       try {
